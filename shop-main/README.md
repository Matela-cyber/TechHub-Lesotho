...
# TechHub Lesotho - Electronics E-Commerce Web App

Welcome to TechHub Lesotho, a modern e-commerce platform for electronics, gadgets, and accessories. Built with **React.js** and **Firebase**, it delivers a seamless, mobile-friendly shopping experience.
...
<img src="screenshots/1.png" alt="TechHub Lesotho Home Page - Main Landing Page" width="100%" style="max-width: 900px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1); margin: 20px 0;">
...
**Live Demo:** [techhublesotho.com](https://techhublesotho.com)
...
1. **Clone the Repository**
   ...
   ```bash
   git clone https://github.com/yourorg/techhub-lesotho.git
   cd techhub-lesotho
   ```
