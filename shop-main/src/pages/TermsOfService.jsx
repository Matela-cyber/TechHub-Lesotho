    ...
    >
      <div className="container mx-auto px-4 py-12">
        ...
        <p className="text-lg text-gray-700 mb-6 leading-relaxed text-center">
          Welcome to{" "}
          <strong className="text-indigo-600">TechHub Lesotho</strong>! By
        ...
        <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          ...
          <strong>TechHub Lesotho</strong> platform. By using our platform, you
          accept these terms in full. If you disagree with any part of these
        ...
        <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          <strong>TechHub Lesotho</strong> is a full e-commerce system developed
          by Datamak Technologies. It provides an online shopping platform for
          computers, ICT products, and web hosting services, with features
          including product catalogues, shopping cart, checkout, order tracking,
        ...
        <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          ...
          property of <strong>TechHub Lesotho</strong> or its respective owners.
        ...
        <p className="text-lg text-gray-700 mb-4 leading-relaxed">
          <strong>TechHub Lesotho</strong> is provided "as is" without any
