        ...
        {cartDetails.length === 0 ? (
          ...
          <>
            ...
            <div className="flex justify-between font-bold mt-6 border-t pt-4">
              <span>Total:</span>
              <span>M{formatPrice(total.toFixed(2))}</span>
            </div>
            <Link
              to="/checkout/shipping"
              className="mt-6 block w-full bg-blue-600 text-white text-center font-semibold py-3 rounded-lg transition-transform transform hover:scale-105 duration-200 shadow-md hover:shadow-lg"
            >
