...
export const createReceiptTemplate = (order, containerId) => {
  ...
  /**
   * Format price as currency in Maloti (LSL)
   *
  ...
  const formatPrice = (price) => {
    ...
    return `M${new Intl.NumberFormat("en-LS", {
    ...
    ">
      ...
      ">
        ...
        ">
          ...
          ">From</h3>
          <div style="color: #1d1d1f; font-size: 11px; line-height: 1.5;">
            <div style="font-weight: 600; margin-bottom: 4px;">TechHub Lesotho (Pty) Ltd.</div>
            <div style="color: #86868b; margin-bottom: 2px;">Maseru, Lesotho</div>
            <div style="color: #86868b; margin-bottom: 2px;">support@techhublesotho.co.ls</div>
            <div style="color: #86868b;">+266 2232 0000</div>
          </div>
        </div>
      </div>
      ...
      ">
        <h3 style="
          ...
          margin: 0 0 8px 0;
          letter-spacing: -0.2px;
        ">Thank you for your order at TechHub Lesotho!</h3>
        <p style="
          font-size: 10px;
          color: #86868b;
          margin: 0;
...
export const downloadOrderReceipt = async (order) => {
  try {
    ...
    await generatePdfFromElement(
      "temp-receipt-container",
      `TechHub-Invoice-${order.orderId}`,
    );
