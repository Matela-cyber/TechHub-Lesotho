...
const Users = () => {
  ...
  const [modalMode, setModalMode] = useState("view"); // view, orders
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      const newUsers = userList.filter(
        (user) =>
          user.createdAt &&
          new Date(user.createdAt.seconds * 1000) >= firstDayOfMonth,
      );
  ...
  // Profile picture view logic removed
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredUsers.map((user, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <Badge variant="info" icon={getProviderIcon(user.provider)}>
                      {user.provider || "email"}
                    </Badge>
                  </td>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-gray-900">
                  {formatCurrency(selectedUser.averageOrderValue || 0)}
                </p>
              </div>
