...
const AddProduct = () => {
  ...
  const validateForm = () => {
    ...
    if (!slugAvailability.available)
      newErrors.slug = "Please check slug availability";
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-2">
                <div className="flex-1">
                  ...
                  {slugAvailability.checked && (
                    <p
                      className={`text-sm mt-1 ${slugAvailability.available ? "text-green-600" : "text-red-600"}`}
                    >
                      {slugAvailability.available
                        ? "✓ URL is available!"
              ...
              {["image", "image2", "image3"].map((imgKey, index) => (
                <div key={imgKey}>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewProduct({ ...newProduct, [imgKey]: e.target.value })
                    }
                  ...
                  {newProduct[imgKey] && (
                    ...
                    >
                      ...
                      <button
                        onClick={() => {
                          setNewProduct({ ...newProduct, [imgKey]: "" });
                        }}
