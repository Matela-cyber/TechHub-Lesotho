...
function Orders() {
  ...
  const applyFilters = useCallback(() => {
    ...
    if (filters.minAmount && !isNaN(parseFloat(filters.minAmount))) {
      ...
      console.log(
        `🔍 Orders: Min amount filter (M${minAmount}) applied, ${filtered.length} orders remaining`,
      );
    }
  ...
  const updateOrderStatus = async (orderId, newStatus, additionalInfo = {}) => {
    ...
    try {
      ...
      if (
        ...
        toast.success(
          `Order ${orderData.orderId || orderId} ${newStatus.toLowerCase()} successfully`,
        );
      }
    } catch (error) {
  ...
  const addTracking = async (e) => {
    ...
    try {
      ...
      if (
        ...
        toast.success(
          `Tracking information added to order ${selectedOrder.orderId || selectedOrder.id}`,
        );
      }
    } catch (error) {
  ...
  const generateAnalytics = async () => {
    ...
    try {
      ...
      const result =
        await AdminOrderService.getOrderAnalytics(analyticsFilters);
        ...
        <div className="mb-8 bg-orange-50 rounded-xl border border-orange-200 p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            ...
            {selectedOrderIds.size > 0 && (
              <div className="flex flex-wrap gap-2">
                <button
                  onClick={() =>
                    handleBulkOperation("update_status", {
                ...
                <button
                  onClick={() =>
                    handleBulkOperation("update_priority", {
          ...
          {selectedOrderIds.size === 0 && (
            <p className="text-orange-700 text-sm bg-orange-100 rounded-lg p-3">
              Select orders using the checkboxes to perform bulk operations like
              approval, priority updates, and more.
            </p>
          )}
        </div>
      )}
        ...
        {filteredOrders.length === 0 ? (
          ...
          <>
            ...
            <div className="bg-gray-50 border-b border-gray-200 px-6 py-4">
              <div
                className={`grid gap-6 items-center font-semibold text-gray-700 text-sm uppercase tracking-wide ${
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div>
                        <span
                          className={`inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold ${statusConfig.color}`}
                        >
                          {statusConfig.label}
                        </span>
                      ...
                      <div>
                        <span
                          className={`inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium ${priorityConfig.color}`}
                        >
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span
                            className={`px-2 py-1 rounded text-xs font-medium ${
                              ORDER_STATUS_CONFIG[selectedOrder.status]
                                ?.color || "bg-gray-100 text-gray-800"
                            }`}
                          >
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="text-gray-900">
                            {formatCurrency(selectedOrder.shipping?.cost || 0)}
                          </span>
                        </div>
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span>
                            {formatCurrency(
                              selectedOrder.financials?.shipping ||
            ...
            <div className="p-6">
              ...
              <div className="mb-8">
                ...
                <div className="bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
                  ...
                  <div className="divide-y divide-gray-200">
                    {analyticsData.topProductsByQuantity
                      .slice(0, 5)
                      .map((product, index) => (
                        <div
