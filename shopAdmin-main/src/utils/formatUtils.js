...
/**
 * Format a currency amount to Maloti (M) format
 * @param {number} amount - The amount to format
 * @param {number} decimals - Number of decimal places (default: 2)
...
/**
 * Convert a number to lakhs format (for large Maloti values)
 * @param {number} value - The value to format
 * @param {number} decimals - Number of decimal places (default: 1)
 * @returns {string} - Formatted string with 'lakh' suffix (Maloti)
 */
export const formatLakhs = (value, decimals = 1) => {
  return `M${(value / 100000).toFixed(decimals)} lakh`;
};

/**
 * Convert a number to crores format (for very large Maloti values)
 * @param {number} value - The value to format
 * @param {number} decimals - Number of decimal places (default: 2)
 * @returns {string} - Formatted string with 'crore' suffix (Maloti)
 */
export const formatCrores = (value, decimals = 2) => {
  return `M${(value / 10000000).toFixed(decimals)} crore`;
};
